...
# Try to import Gemini AI, fallback to rule-based if not available
try:
...
class FetiiChatbot:
    ...
    def setup_gemini(self):
        ...
        if not GEMINI_AVAILABLE:
            st.warning("⚠️ Gemini AI not available. Using rule-based responses.")
            self.gemini_model = None
            return
    ...
    def generate_response(self, user_query, analysis_result):
        ...
        if self.gemini_model is None:
            ...
            return analysis_result['detailed_response']
        ...
        try:
            ...
            return f"I encountered an error generating a response: {str(e)}. Here's what I found: {analysis_result['detailed_response']}"
